...
*NOTE*: In the original implemtation, the url would be added the default port :80 in some matching functions. So the
best format of a url regexp could be: %r|http://example\.com(?::80)?/users|
