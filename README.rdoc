...
The :response's value could alse be a path to a file which stores the entire response from the server. ERB template and
regular expression match capture are supported too.
